...
@app.route("/")
def index():
    return render_template("index.html") # page_title=about | connects to page tittle to --> about,careers and contact.
...
if __name__ == "__main__":
    app.run(
        ...
        debug=True) # ONLY true when you are testing. when deploying it must be FALSE
